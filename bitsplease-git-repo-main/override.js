...
document.addEventListener('DOMContentLoaded', function(){
    const btn = document.getElementById('large-btn')
    btn.addEventListener("click", function(){
        chrome.tabs.insertCSS({
            code: ` *{
...
document.addEventListener('DOMContentLoaded', function(){
    const btn = document.getElementById('x-largefont-btn')
    btn.addEventListener("click", function(){
        chrome.tabs.insertCSS({
            code: ` *{
...
document.addEventListener('DOMContentLoaded', function(){
    const btn = document.getElementById('xx-largefont-btn')
    btn.addEventListener("click", function(){
        chrome.tabs.insertCSS({
            code: ` *{
...
var ntc = {
    ...
    name: function(color) {
      ...
      return (cl < 0 ? [ "Invalid Color: " + color] : [ ntc.names[cl][1]]);
    },
...
document.getElementById('colorid-btn').addEventListener('click', () => {
    ...
    eyeDropper.open().then(result => {
      resultElement.textContent = ntc.name(result.sRGBHex);
